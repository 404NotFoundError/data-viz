...
const MAPBOX_TOKEN = 'pk.eyJ1IjoiZ2FtYTk3ODAiLCJhIjoiY2p2NTluOWlzMHFtczN5bnpub2ttdGNqNyJ9.BIN2o_EDLZM_N_PPVQtrJg'; // Set your mapbox token here
...
export default class App extends Component {
  ...
  componentDidMount() {
    requestJson('../us-income.geojson', (error, response) => {
      if (!error) {
