...
import data from '../helpers/mockups/data';
...
class SinglePage extends Component {
    state = {
        wine: data.filter(wine => parseInt(wine.id) === parseInt(this.props.match.params.id))[0]
    }
                ...
                <div className="singleContainer">
                    <a className="backBtn" href="/dataviz">
                        <svg className="arrow" width="21" height="12" viewBox="0 0 21 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <path d="M2.81824 6H20.0001" stroke="#B2B2B2" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                        </svg>
